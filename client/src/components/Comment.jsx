        ...
        <div className="flex-1">
            ...
            {isEditing ? (
                ...
                <div className="flex justify-end gap-2 text-xs">
                    ...
                    <Button type='button' size='sm' gradientMonochrome='teal' outline onClick={() => setIsEditing(false)}>Cancel</Button>
                </div>
                </>
            ) : (
                <>
                <p className='text-gray-500 pb-2'>{comment.content}</p>
                <div className="flex items-center gap-2 text-xs pt-2 border-t dark:border-gray-700 max-w-fit">
